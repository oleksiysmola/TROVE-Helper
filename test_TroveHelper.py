...
def SetupFormaldehydeTest():
    ...
    yield TestEnergyLevelsObject, TestEnergyLevelsSymmetriesMappedObject, TestMarvelLevelsObject, TestSortedMarvelLevelsObject

def test_ReadTroveEnergies(SetupFormaldehydeTest):
    ExpectedEnergyLevelsObject, _, _, _ = SetupFormaldehydeTest
...
def test_ReadMarvelEnergies(SetupFormaldehydeTest):
    _, _, ExpectedMarvelLevelsObject, _ = SetupFormaldehydeTest
...
def test_ObtainSymmetryMap(SetupFormaldehydeTest):
    TestEnergyLevelsObject, _,  _, _ = SetupFormaldehydeTest
...
def test_ApplySymmetryMapping(SetupFormaldehydeTest):
    TestEnergyLevelsObject, ExpectedEnergyLevelsObject, _, _ = SetupFormaldehydeTest
