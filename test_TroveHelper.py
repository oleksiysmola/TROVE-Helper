...
def SetupFormaldehydeTest():
    ...
    TaggedMarvelLevelsTestInput = [
        [2, 3, 2, 1, 1, 4, 0, 0, 1, 0, 0, 1, "2-1-1-0-0-1-0-0-1", 2083.32885, 0.0026, "05LoUlBe", "0-0-1-0-0-1", "2-2-1-0-0-1-0-0-1"],
        [1, 4, 3, 1, 2, 4, 0, 0, 1, 0, 0, 1, "3-1-2-0-0-1-0-0-1", 2089.59045, 0.0026, "05LoUlBe", "0-0-1-0-0-1", "1-3-1-0-0-1-0-0-1"],
        [1, 4, 2, 1, 2, 4, 0, 0, 1, 0, 0, 1, "2-1-2-0-0-1-0-0-1", 2082.71350, 0.0026, "05LoUlBe", "0-0-1-0-0-1", "1-2-1-0-0-1-0-0-1"]
    ]
...
def test_ApplyReplaceWithTroveQuantumNumbers(SetupFormaldehydeTest):
    ...
    OutputMarvelEnergyLevelsObject = ApplyReplaceWithQuantumNumbersFromTag(InputMarvelEnergyLevelsObject)
